...
const Module3Page = () => {
  return (
    <ModuleLayout moduleId={3} moduleTitle="Spotlight on Social Media and AI">
      ...
      <section id="intro" className="mb-24 scroll-mt-24">
        <div className="bg-editorial-orange shadow-lg p-8">
          ...
          <div className="space-y-4 text-editorial-cream font-light leading-relaxed text-lg">
            <p>
              This module will examine how social media algorithms and AI shape the information we see.
              Learn to recognize filter bubbles, echo chambers, and AI-generated content.
            </p>

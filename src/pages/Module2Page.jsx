      ...
      <section id="intro" className="mb-24 scroll-mt-24">
        <div className="bg-editorial-orange shadow-lg p-8">
          ...
          <div className="space-y-4 text-editorial-cream font-light leading-relaxed text-lg">
            <p>
              This module will explore how news is created, reported, and consumed in the modern media landscape.
              You'll learn to identify bias, recognize manipulation techniques, and become a more critical consumer of news.
            </p>

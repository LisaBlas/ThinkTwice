...
const Module6Page = () => {
  return (
    <ModuleLayout moduleId={6} moduleTitle="Spotlight on Interactions: Heated Argument or constructive Debate?">
      ...
      <section id="intro" className="mb-24 scroll-mt-24">
        <div className="bg-editorial-orange shadow-lg p-8">
          ...
          <div className="space-y-4 text-editorial-cream font-light leading-relaxed text-lg">
            <p>
              This module will teach you how to engage in constructive debates and avoid heated arguments.
              Learn techniques for productive discourse and how to respond to faulty reasoning with confidence.
            </p>

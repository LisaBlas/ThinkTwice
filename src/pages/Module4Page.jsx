...
const Module4Page = () => {
  return (
    <ModuleLayout moduleId={4} moduleTitle="Spotlight on Science and Academia">
      ...
      <section id="intro" className="mb-24 scroll-mt-24">
        <div className="bg-editorial-orange shadow-lg p-8">
          ...
          <div className="space-y-4 text-editorial-cream font-light leading-relaxed text-lg">
            <p>
              This module will help you understand how to evaluate scientific claims and academic research.
              Learn to distinguish between good science and pseudoscience, and understand the peer review process.
            </p>
